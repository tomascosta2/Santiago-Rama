...
import { descriptionCalender, titleCalender, VIDEO_TESTIMONIALS, waNumber, locationCalender, idVsl, idThankyou, srcThankyou, coachFullName, TESTIMONIALS_THANKYOU_IMG, coachName } from "@/app/utils/constantes";
